...
## Usage
Scripts details, input and output specifics are in [R](https://gitlab.mpcdf.mpg.de/luciat/castom-igex_mr/-/blob/main/R) folder. Usage in the context of Coronary Artery Disease (UK Biobank) and Schizophrenia (PGC) are in [Application](https://gitlab.mpcdf.mpg.de/luciat/castom-igex_mr/-/tree/main/Usage) folder.

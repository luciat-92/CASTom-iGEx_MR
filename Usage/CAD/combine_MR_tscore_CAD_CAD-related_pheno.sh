...
do
	...
	mrRes_tscore_rev_Egg+=(OUTPUT_GTEx/predict_CAD/${t}/200kb/CAD_GWAS_bin5e-2/UKBB/devgeno0.01_testdevgeno0/enrichment_CADHARD_res/CADCardioG_dist200000b_Mendelian_randomization_reverse_Egger_tscore_pvalFDRrel0.05.txt)
	...
	mrRes_tscore_rev_IVW+=(OUTPUT_GTEx/predict_CAD/${t}/200kb/CAD_GWAS_bin5e-2/UKBB/devgeno0.01_testdevgeno0/enrichment_CADHARD_res/CADCardioG_dist200000b_Mendelian_randomization_reverse_IVW_tscore_pvalFDRrel0.05.txt)
done

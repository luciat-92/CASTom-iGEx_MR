...
Rscript ${git_fold}plot_correlation_MR_pheno_related_run.R \
	...
	--mrRes_Egg_rev_file ${fold}perc0.3_tot_path_Mendelian_randomization_reverse_Egger_estimates_allTissues.txt \
	--mrRes_Egg_pval_file ${fold}perc0.3_tot_path_Mendelian_randomization_Egger_estimates_pvalue_allTissues.txt \
	--mrRes_Egg_pval_rev_file ${fold}perc0.3_tot_path_Mendelian_randomization_reverse_Egger_estimates_pvalue_allTissues.txt \
	--mrRes_Egg_intpval_file ${fold}perc0.3_tot_path_Mendelian_randomization_Egger_inter_estimates_pvalue_allTissues.txt \
	--mrRes_Egg_intpval_rev_file ${fold}perc0.3_tot_path_Mendelian_randomization_reverse_Egger_inter_estimates_pvalue_allTissues.txt \
	--mrRes_IVW_file ${fold}perc0.3_tot_path_Mendelian_randomization_IVW_estimates_allTissues.txt \
	--mrRes_IVW_rev_file ${fold}perc0.3_tot_path_Mendelian_randomization_reverse_IVW_estimates_allTissues.txt \
	--mrRes_IVW_pval_file ${fold}perc0.3_tot_path_Mendelian_randomization_IVW_estimates_pvalue_allTissues.txt \
	--mrRes_IVW_pval_rev_file ${fold}perc0.3_tot_path_Mendelian_randomization_reverse_IVW_estimates_pvalue_allTissues.txt \
	--mrRes_IVW_FDRpval_file ${fold}perc0.3_tot_path_Mendelian_randomization_IVW_estimates_FDRpvalue_allTissues.txt \
	--mrRes_IVW_FDRpval_rev_file ${fold}perc0.3_tot_path_Mendelian_randomization_reverse_IVW_estimates_FDRpvalue_allTissues.txt \
	--mrRes_Egg_intFDRpval_file ${fold}perc0.3_tot_path_Mendelian_randomization_Egger_inter_estimates_FDRpvalue_allTissues.txt \
	--mrRes_Egg_intFDRpval_rev_file ${fold}perc0.3_tot_path_Mendelian_randomization_reverse_Egger_inter_estimates_FDRpvalue_allTissues.txt \
	--mrRes_Egg_FDRpval_file ${fold}perc0.3_tot_path_Mendelian_randomization_Egger_estimates_FDRpvalue_allTissues.txt \
	--mrRes_Egg_FDRpval_rev_file ${fold}perc0.3_tot_path_Mendelian_randomization_reverse_Egger_estimates_FDRpvalue_allTissues.txt \
	--mrRes_Egg_int_file ${fold}perc0.3_tot_path_Mendelian_randomization_Egger_inter_estimates_allTissues.txt \
	--mrRes_Egg_int_rev_file ${fold}perc0.3_tot_path_Mendelian_randomization_reverse_Egger_inter_estimates_allTissues.txt \
